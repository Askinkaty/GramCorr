...
#    mkdir -p $ERRANT_DIR/TMP_XML/$MODEL

    cd $ERRANT_DIR
#    python3 ./parallel_to_m2.py -orig $DATA_DIR/source.ru -cor $DATA_DIR/target.ru -out ref_ru_m2 -lang ru
#    python3 ./parallel_to_m2.py -orig $DATA_DIR/fold${i}/train.en -cor $DATA_DIR/fold${i}/train.de -out ref_fold${i}_m2 -lang de
...
#    mv hp_fold${i}_m2 $ERRANT_DIR/TMP_XML/$MODEL
     python3 ./compare_m2.py -hyp $ERRANT_DIR/TMP_XML/$MODEL/hp_fold${i}_m2 -ref $ERRANT_DIR/TMP_XML/$MODEL/ref_fold${i}_m2 #>> out.csv
#
